<template>
  <n-card class="item-container" :bordered="false" hoverable>
    <div class="info-wrapper">
      ...
      <div class="mt-1">
        <n-button class="mr-1" secondary round type="error" size="tiny" @click="preView">Preview address</n-button>
        <n-button secondary round type="success" size="tiny" @click="gitee">project address</n-button>
      </div>
    </div>
  </n-card>
</template>
