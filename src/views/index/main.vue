        ...
        <DataItem :data-model="item">
          <template v-if="index === 0" #extra="{ extra }">
            <div class="margin-top-lg">
              <div> Newly added from yesterday:{{ extra.data }} </div>
              <div class="margin-top-sm"> Newly added last week:{{ extra.data1 }} </div>
            </div>
          </template>
    ...
    return {
      ...
      dataList: [
        ...
        },
        {
          title: 'New users',
          data: '+500',
          bottomTitle: 'Total user quantity',
          totalSum: '2 million+',
        ...
        {
          title: 'Order volume of the month',
          data: '189 pens',
          bottomTitle: 'Cumulative order quantity',
          totalSum: '10000+',
