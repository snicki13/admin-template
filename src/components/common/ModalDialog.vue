<template>
  <n-modal v-model:show="showModal" preset="card" :title="title" size="small" class="modal-dialog-wrapper"
    header-style="padding: 10px 20px" :bordered="false" :style="bodyStyle" :segmented="segmented"
