<template>
  <n-cascader :default-value="defaultValue" value-field="code" label-field="name" :options="dataOptions"
    :placeholder="placeholder" :check-strategy="checkStrategy" clearable filterable :on-update:value="onValueChange" />
</template>
...
const placeholder = computed(() => {
  if (props.dataType === 'province') {
    ...
    return 'Please select provinces and cities'
  } else if (props.dataType === 'pca') {
    return 'Please select the provincial and cities'
  }
  return 'Please select the provincial and municipal districts and streets'
})
